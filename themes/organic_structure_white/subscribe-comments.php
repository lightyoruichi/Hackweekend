...
<!-- You can start editing here. -->
	...
	<h5><?php _e("Trackbacks", 'organicthemes'); ?></h5>
...
<p><?php do_shortcode('[wdfb_connect] Apply Now with Facebook [/wdfb_connect] ');?> </p>
...
<?php _e("Logged in as", 'organicthemes'); ?> <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a> 
...
<input name="submit" type="submit" class="info-button" tabindex="5" value="Apply for Hackweekend" value="
