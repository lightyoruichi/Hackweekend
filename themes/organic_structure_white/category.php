	...
	<div id="contentarchive">
		...
		<div class="postarea">
            ...
            <h3><a href="<?php the_permalink() ?>" rel="bookmark"><?php the_title(); ?></a></h3>
                ...
                <div class="postimg"><a href="<?php the_permalink() ?>" rel="bookmark"><img src="<?php echo get_post_meta($post->ID, "thumbnail", true); ?>" alt="<?php the_title(); ?>" /></a></div>
                <?php else: ?>
                <?php endif; ?>

			<!--The archive page is currently using the Limit Post funtion and is currently set to display 380 characters. You can increase or decrease it as you wish.-->

            <?php the_content_limit(380, "Read More"); ?><div style="clear:both;"></div>   
