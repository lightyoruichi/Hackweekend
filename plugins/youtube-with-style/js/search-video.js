;(function($) {
		...
		function flashHtml(url) {
		    return '<object type="application/x-shockwave-flash" width="' + videoWidth + '" height="' + videoHeight + '"><param name="movie" value="' + player + '" /><param name="allowFullScreen" value="true" /><param name="allowscriptaccess" value="always" /><param name="flashvars" value="playOnStart=true&MediaLink='+url+'" /></object>';	
		}
