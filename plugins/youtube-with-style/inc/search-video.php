	...
	<img src="<?php echo YT_URL.'images/search_icon.png';?>" class="logo" alt="" />
	...
	<script type="text/javascript">
	    ...
	    var lastOrderby = "";
	    var xhr = null;
	    var videoWidth = <?php echo get_option('player_width'); ?>;
	    var videoHeight = <?php echo get_option('player_height'); ?>;
	    //]]>
	</script>
